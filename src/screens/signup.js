...
const RegisterScreen = ({navigation}) => {
  ...
  const [passwordconError, setconPasswordError] = useState('');
  ...
  const validateconpassword = () => {
    ...
    if (conpassword!==password) {
      setconPasswordError('Please enter same above Password');
    } else if (conpassword === '') {
        setconPasswordError('Please enter same above Password');
    }
    else {
 ...
 {emailError ? <Text style={styles.errorText}>{emailError}</Text> : null}
    ...
    {passwordError ? (
        ...
        />
    {passwordconError ? (
        <Text style={styles.errorText}>{passwordconError}</Text>
      ) : null}
        <View
          style={{
            flexDirection: 'row',
